...
export default function RestaurantList() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 shadow-[0_4px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)] border border-gray-100 dark:border-gray-700">
        <div className="text-center">
          <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Building2 className="w-10 h-10 text-blue-600 dark:text-blue-300" />
          </div>
          <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Restoranlar yo'q</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-md mx-auto">Hozircha restoranlar mavjud emas. Birinchi restoraningizni qo'shing va boshqarishni boshlang.</p>
